    ...
    return (
        ...
        <main className="min-h-[calc(100vh-57px-97px)] flex-1">
            ...
            <section className="mx-auto flex max-w-[980px] flex-col items-center gap-2 py-8 md:py-12 md:pb-8 lg:py-24 lg:pb-6">
                ...
                <div className="flex w-full items-center justify-center space-x-4 py-4 md:pb-6">
                <p className="text-center text-lg font-light text-foreground">
                You agree to indemnify, defend and hold harmless AfterFall and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, Service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.
                </p>
                </div>
